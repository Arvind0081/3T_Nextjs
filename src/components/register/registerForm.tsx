...
const RegisterForm = ({ departmentData }: any) => {
  ...
  const handleRegisteration = async (data: RegiserFormValues) => {
    ...
    formData.append(
      "ExperienceOnJoining",
      (Number(data.month) + Number(data.year) * 12).toString()
    );
  ...
  return (
    <form className="form-row" onSubmit={handleSubmit(handleRegisteration)}>
      ...
      <div className="form-row FlexFields">
        ...
        <div className="form-group">
          ...
          >
            ...
            {designationData.map((item: DesignationModel) => (
          ...
          {errors.designation && (
            <div className="validation_error">
              <span role="alert">{errors.designation.message}</span>
            </div>
          )}
        </div>
      </div>
      <div className="form-row FlexFields">
        <div className="form-group">
          ...
          {errors.joiningDate && (
            <div className="validation_error">
              <span role="alert">{errors.joiningDate.message}</span>
            </div>
          )}
        </div>
        <div className="form-group">
          <label htmlFor="month">
            Total Experience On Joining Date <span className="astrisk">*</span>
          </label>
          <div className="d-flex gap-x-2">
            <input
              ...
              {...register("month", {
                ...
                max: {
                  value: 12,
                  message: "Experience must be between 1 to 12",
                },
                min: {
                  value: 0,
                  message: "Experience must be between 0 to 12",
                },
              })}
            />
            <input
          ...
          {errors.month && (
            <div className="validation_error">
              <span role="alert">{errors.month.message}</span>
            </div>
          )}
          {errors.year && (
            <div className="validation_error">
      ...
      <div className="form-row FlexFields">
        <div className="form-group">
          <label htmlFor="address">
            Address <span className="astrisk">*</span>
          </label>
          <input
            id="address"
            type="text"
        ...
        <div className="form-group">
          <div className="d-flex justify-content-between">
            ...
            <span
              className=""
              title="Please enter either Employee ID or Device ID. If you do not have this information, please contact HR for assistance."
            >
          ...
          {errors.employeeNumber && (
            <div className="validation_error">
              <span role="alert">{errors.employeeNumber.message}</span>
            </div>
          )}
        </div>
      </div>
