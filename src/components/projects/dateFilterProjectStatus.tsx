...
const DateFilter=({startDate,setStartDate,endDate,setEndDate}:any)=>{
   ...
   //  const [startDate,setStartDate]=useState(payload.statusStartDate);
   //  const [endDate,setEndDate]=useState(payload.statusEndDate);
...
//         router.push(`${url}/?ProjectId=${payload.id}&ModuleStatus=${moduleStatusString}&PaymentStatus=${paymentStatusString}&BillingStartDate=${payload.billingStartDate}&BillingEndDate=${payload.billingEndDate}&StatusStartDate=${startDateValue}&StatusEndDate=${endDate}&PageSize=${payload.pageSize}&PageNumber=${payload.pageNumber}&SearchValue=${payload.searchValue}`);
// router.refresh();
    };
    ...
    const handleEndDate=(e: { target: { value: any; }; })=>{
      ...
      //   router.push(`${url}/?ProjectId=${payload.id}&ModuleStatus=${moduleStatusString}&PaymentStatus=${paymentStatusString}&BillingStartDate=${payload.billingStartDate}&BillingEndDate=${payload.billingEndDate}&StatusStartDate=${startDate}&StatusEndDate=${endDateValue}&PageSize=${payload.pageSize}&PageNumber=${payload.pageNumber}&SearchValue=${payload.searchValue}`);
      //   router.refresh();
    };
