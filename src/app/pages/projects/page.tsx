...
import {projectsStatus,projects, projectsHiring, projectsBillingType, projectsClientList, individualProjectStatus,projectsHiringFilter,projectsBillingTypeFilter, getApplicationDomain, technologyList} from '@/utils/publicApi';
import {ProjectInfoModel,GetAllProjectsParamsModel, applicationDomainModel, Technology} from '@/utils/types';
...
const showingRecordCount = () => {
    ...
    return `${startRecord} to ${endRecord} of ${totalRecords} entries`;
};
                                        ...
                                        <div className='card custom-card'>
                                            ...
                                            <div className='filter-left d-flex gap-x-2 project_leftBox'>
                                             ...
                                             <BillingAndHiringStatusFilter data={data} hiringTypeFilter={hiringTypeFilter} billingTypeFilter={billingTypeFilter}/>
                                                   ...
                                                   <Search data={data} />
                                                    <AddProjectButton projectStatusData={projectStatusData} hiringType={hiringType} billingType={billingType} clientList={clientList} applicationDomain={applicationDomain} technologies={technologies}/>
                                                </div>
                                            </div>
                                            <div className='card-body'>
                                                ...
                                                <ProjectTable allProjects={allProjects} projectStatusData={projectStatusData} hiringType={hiringType} billingType={billingType} clientList={clientList} data={data} applicationDomain={applicationDomain} technologies={technologies}/>
                                                {allProjects.length ==
                                                                0 && (
                                                                <span>
                                                                    No record
