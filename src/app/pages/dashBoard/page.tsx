...
const Dashboard = async ({ searchParams }: any) => {
  ...
  const calculateTotalExperience = (
    ...
    const totalMonths = joining
      ? (new Date().getFullYear() - joining.getFullYear()) * 12 +
                              ...
                              {teamLead?.teamMembers?.map((member: any) => {
                                const totalExperience =
                                  calculateTotalExperience(
                                    member.teamMemberJoiningDate,
                                    Number(member.teamMemberExperienceOnJoining)
                                  );
                                    ...
                                    <div className="d-flex align-items-center flex-wrap">
                                      <div className="me-2">
                                        <span className="avatar avatar-sm avatar-rounded bg-transparent">
                                          <span
                                            className={`avatar avatar-sm avatar-rounded ${colorClass} fw-semibold`}
                                          >
                                      ...
                                      <div className="flex-fill">
                                        <Link
                                          ...
                                          className={`fw-semibold mb-0 fs-13 ${getDesignationNameClass(totalExperience)}`} // Apply the class here
                                        >
                                          {member.teamMemberName}
                                        </Link>
                                      </div>
